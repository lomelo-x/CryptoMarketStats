...
const styles = StyleSheet.create({
	...
	rightContainer: {},
	titleContainer: {},
	coinTitle: { color: 'lightgrey', fontSize: 24,  },
	coinSubTitle: { color: 'lightgrey', fontSize: 24,  },
	coinPrice: { color: 'lightgrey', fontSize: 24,  },
	coinSubPrice: { color: 'lightgrey', fontSize: 24,  },
});
